...
class NotifyExport implements FromCollection, WithHeadings
{
    ...
    {
        return [
            'Lamp Type', 'Direction', 'Direction Number', 'Routes', 'Control', 'KM', 
            'Latitude', 'Longitude', 'Field of View', 'Range', 'Name ID', 'Status', 
